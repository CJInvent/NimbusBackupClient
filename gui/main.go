...
func (a *App) startup(ctx context.Context) {
	...
	// The restore listing cache is NOT trimmed here any more. It is written
	// by the service, which is now the only process that lists a snapshot,
	// and a console reaching into another process's cache directory was only
	// ever correct while the two were the same process. See service.go.
